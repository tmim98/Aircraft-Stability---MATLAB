...
%
% Notes:
% 1) This is an input-only file. It does not call the lateral core.
...
% Working values estimated from Navion drawings / geometry reconstruction.
pAV.Sv      = 13.0;       % ft^2
pAV.lv      = 6.8;        % ft
pAV.bv      = 5.07;       % ft
...
% Still unresolved / separate chart-based items
pAV.S_bs    = NaN;        % ft^2, projected side area of aircraft
pAV.l_f     = NaN;        % ft, fuselage length
...
% Workbook reference values for the NAVION. These can be used directly as
% validation targets for a geometry-based lateral/directional core.
pAV.CY_beta    = -0.564;
pAV.Cl_beta    = -0.074;
pAV.Cn_beta    =  0.071;
...
pAV.fig_2_30_csv = fullfile(pAV.digitized_figures_folder, ...
    'figure_2_30_digitized_samples.csv');
